...
class BaseOptions():
    ...
    def initialize(self):                
        ...
        self.parser.add_argument('--dataroot', type=str, default='datasets/ouluData/')
        ...
        self.parser.add_argument('--resize_or_crop', type=str, default='oulu128', help='scaling and cropping of images at load time [resize_and_crop|crop|scaledCrop|scaleWidth|scaleWidth_and_crop|scaleWidth_and_scaledCrop|scaleHeight|scaleHeight_and_crop] etc')
